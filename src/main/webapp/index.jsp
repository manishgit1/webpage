...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Manish Poudel</a>
			<button
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						I am enthusiastic student who is willing to build up good career in tech industry with main focus on Java Development <br>
						<a href="https://github.com/manishgit1">My Github</a> 
					</p>
				</div>
			</div>
		</div>
